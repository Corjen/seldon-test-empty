...
export type CardProductVariant02Props = HTMLAttributes<HTMLElement> & {
...
export const CardProductVariant02 = ({
  style,
  textblockDetailsProps,
...
type DefaultProps = {
  component: CardProductVariant02Props
  children: CardProductVariant02Props
}
