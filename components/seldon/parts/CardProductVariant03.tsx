...
export type CardProductVariant03Props = HTMLAttributes<HTMLElement> & {
...
export const CardProductVariant03 = ({
  style,
  textblockDetailsProps,
...
type DefaultProps = {
  component: CardProductVariant03Props
  children: CardProductVariant03Props
}
