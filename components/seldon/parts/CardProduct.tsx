...
const sdn: CardProductProps = {
  textblockDetails: {
    className: "sdn-textblock-details--va-oka-vk-n",
  },
  tagline: {
    children: "Tagline",
    htmlElement: "p",
    className: "sdn-tagline-g0mf-j1-p-x",
  },
  titleProps: {
    children: "Product Card Title",
    htmlElement: "h4",
    className: "sdn-title-uu-mhi-w-d-u",
  },
  description: {
    children:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec purus.",
    htmlElement: "p",
    className: "sdn-description--c9v-pjh3x",
  },
  barButtons: {
    className: "sdn-bar-buttons-c-ipbspp-h",
  },
  button: {
    className: "sdn-button--dg2-tg-q1p",
  },
  icon: {
    icon: "material-add",
    className: "sdn-icon-h-z-gb-fk-l1",
  },
  label: {
    children: "添加",
    htmlElement: "label",
    className: "sdn-label--i-y-rz-sq4o",
  },
  button2: {
    className: "sdn-button-6-c-f-zmc-gn",
  },
  icon2: {
    icon: "material-remove",
    className: "sdn-icon--t-o-p3-vc0t",
  },
  label2: {
    children: "移除",
    htmlElement: "label",
    className: "sdn-label--re-l-n-u4-b-p",
  },
  button3: {
    className: "sdn-button-t-tt-yk-zdn",
  },
  icon3: {
    icon: "__default__",
    className: "sdn-icon--o60u-hl-ex",
  },
  label3: {
    children: "按钮",
    htmlElement: "label",
    className: "sdn-label--c0ljnw4-m",
  },
}
