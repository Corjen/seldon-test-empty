...
export type CardProductVariant01Props = HTMLAttributes<HTMLElement> & {
...
export const CardProductVariant01 = ({
  style,
  textblockDetailsProps,
...
type DefaultProps = {
  component: CardProductVariant01Props
  children: CardProductVariant01Props
}
